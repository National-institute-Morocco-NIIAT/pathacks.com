...
[Live example](https://songz.pathacks.com/js1/lanister.html)
...
1. [Create an HTML page](https://songz.pathacks.com/js0/2.html) with an input box
...
2. [Create a UI (user interface) for JS0 challenge 1](https://songz.pathacks.com/js0/3.html) -
...
3. [Create a UI for JS1 challenge 2](https://songz.pathacks.com/js0/4.html) - Add an
...
4. [Create a UI for JS0 challenge 7](https://songz.pathacks.com/js0/5.html) - Add 2
...
5. [Create a UI for JS0 challenge 8](https://songz.pathacks.com/js0/6.html) - Add 2
...
6. [Create a UI for JS0 challenge 9](https://songz.pathacks.com/js0/7.html) - Create
