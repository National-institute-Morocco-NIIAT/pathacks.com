...
- `OPTIONS` - An OPTIONS request is sent by the browser for security reasons;
  ...
  1. You are currently on `[pathacks.com](http://pathacks.com)`.
...
1. [Save the code here](https://js5.pathacks.com/setup_todo.html) into a html file
...
3. We can't login, because we don't have an account. Thankfully there is a
   ...
   [`https://js5.pathacks.com/auth/api/users`](https://js5.pathacks.com/auth/api/users)
...
4. To check whether your browser successfully followed the response instruction
   ...
   `[https://js5.pathacks.com](https://js5.pathacks.com/auth/api/sessions)`, you must go
...
[Final product](https://js5.pathacks.com/todo.html). There are a few important
...
- **Cross Site Request** - A cross site request is a request that the browser
  ...
  sent to [js5.pathacks.com](http://js5.pathacks.com) (different domain). In the
