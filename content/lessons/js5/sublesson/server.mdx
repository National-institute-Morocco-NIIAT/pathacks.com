...
[https://pathacks.com:3000/hello](https://pathacks.com:3000/hello)
...
1. [Create a get path called `/count`](https://js5.pathacks.com/examples/count) that
...
2. [Create a get path called](https://js5.pathacks.com/examples/delay) `/delay` that
...
3. [GetFile:](https://js5.pathacks.com/examples/getfile) Create a file with the file
...
4. [Easy AB Testing](https://js5.pathacks.com/examples/abtest). Create a path called
...
1. [Depending on which browser, display hello world in red or blue (chrome vs firefox)](https://js5.pathacks.com/examples/browser)
...
3. [Show how many distinct users have visited a site](https://js5.pathacks.com/examples/distinct) -
...
4. [AB Testing](https://js5.pathacks.com/examples/ab) - 1 in 3 visitors who visits
...
1. [Custom Delay](https://js5.pathacks.com/examples/delayed?time=2000): When user
...
2. [Guest Note](https://js5.pathacks.com/examples/notes): When users visit
...
3. [Online Users](https://js5.pathacks.com/examples/online?name=hello): When user
...
[http://url:port/c0d3.png](https://pathacks.com:300/c0d3.png)
...
Example: [Drag and Drop front end](https://js5.pathacks.com/examples/dnd)
...
2. [Picture Saver](https://js5.pathacks.com/examples/webcam): Starting with a webcam
