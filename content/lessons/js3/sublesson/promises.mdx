...
> different formats. Register.gov, Facebook.com, google.com, and pathacks.com all
...
1. Send a request to
   `[https://www.pathacks.com/api/lessons](https://www.pathacks.com/api/lessons)` and
...
1. **Tests**
   ...
   describe('lessons', () => {
     test(`console log should not be called if lessons `, () => {
       ...
       expect(firstCall[0]).toEqual('https://pathacks.com/api/lessons')
     })
...
3. **Explanation**
   - Require `request`.
   - Send the request to
     [`https://pathacks.com/api/lessons`](https://pathacks.com/api/lessons).
...
4. **Code**
   ...
   request('https://pathacks.com/api/lessons', (err, res, body) => {
...
3. **Explanation**
   ...
   - Send the request to `https://pathacks.com/api/lessons`.
     - After we get the data, we need to convert the data into an array using
       `JSON.parse` .
...
sending a request to `[pathacks.com](https://pathacks.com)` and
[displaying how many lessons](https://songz.pathacks.com/js3/req.html) there are.
...
fetch('https://www.pathacks.com/api/lessons').then( (res) => {
  return res.json()
}).then( (data) => {
...
5. [Create an HTML file](https://songz.pathacks.com/js3/lesson.html) that sends a
   request to
   `[https://www.pathacks.com/api/lessons](https://www.pathacks.com/api/lessons)` and
   [displays each lesson title](https://songz.pathacks.com/js3/lessonTitle.html)
   inside an `h1` tag.
...
- **Part 2:**
  [When you click on the lesson title](https://songz.pathacks.com/js3/lesson.html),
  alert the lesson description.

6. [Create an HTML page](https://songz.pathacks.com/js3/country.html) of all the
...
[Play this game](https://songz.pathacks.com/js4/minesweeper/) and win it. After you
