...
1. [Create a dynamic select option generator](https://songz.pathacks.com/js2/1.html):
...
2. [Create a todo list](https://songz.pathacks.com/js2/2.html): Click the **Add**
...
- **Part 2:** [Save the todo items](https://songz.pathacks.com/js2/2b.html) on the
...
- **Part 3:** [Add a filter functionality](https://songz.pathacks.com/js2/2c.html):
...
3. [Create a storybook](https://songz.pathacks.com/js3/storybook.html), a site where
   you can read a book.
...
4. [Create a Friend Age Notebook](https://songz.pathacks.com/js2/3.html), a site to
...
- **Part 2:**
  [ Add localStorage to store the data, then hide the age](https://songz.pathacks.com/js2/3b.html)
