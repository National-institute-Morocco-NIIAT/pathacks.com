...
2. [Display mouse position only on hover](https://songz.pathacks.com/js4/examples/mouse.html).
...
3. [Build a typewriter](https://songz.pathacks.com/js4/examples/typewriter.html).
...
4. [Build a text hiding tool](https://songz.pathacks.com/js4/examples/encode.html)
...
text
[(here's a live example)](https://songz.pathacks.com/js4/examples/createh1.html).
...
1. [Create a click recorder](https://songz.pathacks.com/js4/exercises/clickRecord.html).
...
2. Build this
   [counter clicker](https://songz.pathacks.com/js4/examples/counter.html). Click on
...
3. [Build this experience](https://songz.pathacks.com/js4/examples/register.html).
...
```jsx
<audio
  src="https://songz.pathacks.com/js4/examples/0415.mp3"
  class="aud"
  controls
></audio>
```
...
audio.src = 'https://songz.pathacks.com/js4/examples/0347.mp3'
...
video.src = "https://songz.pathacks.com/js4/examples/ankurBunny.mp4"
...
[display the video from your webcam](https://songz.pathacks.com/js4/examples/webcam.html)!
...
[In this example](https://songz.pathacks.com/js4/examples/canvas.html) we first
...
- https://songz.pathacks.com/js4/examples/0415.mp3
- https://songz.pathacks.com/js4/examples/0347.mp3

1. [Build an audio hover player](https://songz.pathacks.com/js4/examples/audio.html):
...
2. [Change the above display](https://songz.pathacks.com/js4/examples/audio2.html)
...
3. [Build a hover-to-play video](https://songz.pathacks.com/js4/examples/video.html):
   Mouse over the video to play it and display a timer.

- Video URL:
  [https://songz.pathacks.com/js4/examples/ankurBunny.mp4](https://songz.pathacks.com/js4/examples/ankurBunny.mp4)
...
4. [Build a meme image generator](https://songz.pathacks.com/js4/examples/meme.html):
...
5. [Exploding text](https://songz.pathacks.com/js4/examples/explode.html): When you
...
[generate a random bio for a random person](https://songz.pathacks.com/js4/examples/chance.html).
...
[sketches](https://songz.pathacks.com/js4/examples/popper.html) on your website.
...
1. [Markdown to HTML](https://songz.pathacks.com/js4/examples/md.html): Use the
...
2. Build an [accent reader](https://songz.pathacks.com/js4/exercises/accent.html)
...
<a href="https://pathacks.com">Go To Link</a>
<select>
...
Example: `<a href="https://pathacks.com">Click me</a>`.
