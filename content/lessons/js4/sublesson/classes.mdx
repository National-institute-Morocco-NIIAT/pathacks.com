...
**[create a moving circle where the user clicks](https://songz.pathacks.com/js4/examples/circles.html)**.
...
1. [Modify the previous video caption](https://songz.pathacks.com/js4/exercises/vidCaption2.html)
   exercises to use class objects when a caption is created.

<Spoiler name="EMPTY Overview"> </Spoiler>

2. [Create circles that starts with 10 lives](https://songz.pathacks.com/js4/exercises/circleLife.html).
...
3. [Create an `nxn` box creator](https://songz.pathacks.com/js4/exercises/rowGen.html).
...
- **Part 2:**
  [Add the ability to click to reveal row and column numbers](https://songz.pathacks.com/js4/exercises/rowGen2.html).
...
4. [Display characters and all configurations](https://songz.pathacks.com/js4/exercises/warMap.html)
   given the CSS file.

   [https://songz.pathacks.com/js4/exercises/war.css](https://songz.pathacks.com/js4/exercises/war.css)
...
Import the [War CSS](https://songz.pathacks.com/js4/exercises/war.css) library the
same way you would an external stylesheet and then select divs based on their
class.

```html
<link rel="stylesheet" href="https://songz.pathacks.com/js4/exercises/war.css" />
...
5. [Create a character on click](https://songz.pathacks.com/js4/exercises/war.html).
...
6. [Functional TodoList](https://songz.pathacks.com/js4/exercises/todo1.html).
...
3. Write a `fetchData` function that takes in a string (URL) and returns a
   ...
   ```jsx
   fetchData('https://pathacks.com/api/lessons').then(data => {
   ...
   ```jsx
   fetch('https://pathacks.com/api/lessons')
     .then(r => {
       return r.json()
     })
     .then(data => {
...
[nose detection application](https://songz.pathacks.com/js4/ml/face.html).
...
1. [Sentiment Analysis](https://songz.pathacks.com/js4/ml/sentiment.html): Build a
...
2. [Magic Oracle](https://songz.pathacks.com/js4/ml/oracle.html): **Character
   ...
   1. We'll use ml5.js's `charRNN` class. Start by loading the `shakespeare`
      ...
      const charRNN = ml5.charRNN(
        'https://songz.pathacks.com/js4/models/lstm/shakespeare',
        modelLoaded
      )
...
- Harry Potter:
  [https://songz.pathacks.com/js4/models/lstm/jkrowling_HP](https://songz.pathacks.com/js4/models/lstm/jkrowling_HP)
- Hemingway:
  [https://songz.pathacks.com/js4/models/lstm/hemingway](https://songz.pathacks.com/js4/models/lstm/hemingway)
- Zora Neale Hurston:
  [https://songz.pathacks.com/js4/models/lstm/zora_neale_hurston](https://songz.pathacks.com/js4/models/lstm/zora_neale_hurston)
...
```jsx
const charRNN = ml5.charRNN('https://pathacks.com/lstm/shakespeare', modelLoaded)
```
...
3. [Object Detection](https://songz.pathacks.com/js4/exercises/videoDetect.html):
...
[Video Link](https://songz.pathacks.com/js4/exercises/cars.mp4)
