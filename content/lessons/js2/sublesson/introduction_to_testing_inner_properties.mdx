...
1. [Create an h1 element that says](https://songz.pathacks.com/js1/1.html)
...
2. [Start with a button called Start.](https://songz.pathacks.com/js1/2.html) When
...
3. [Build a closure UI](https://songz.pathacks.com/js1/3.html). BTW, UI means User
...
4. [Hello String Generator UI](https://songz.pathacks.com/js1/4.html). Create a page
...
5. [String Breaker.](https://songz.pathacks.com/js1/5.html) Split the input string
...
6. [House Of Primes](https://songz.pathacks.com/js1/6.html). Create an input box, a
...
- **[Part 2](https://songz.pathacks.com/js1/6b.html)**: Display each number in its
  own h1 element.
...
7. [Delayed typing](https://songz.pathacks.com/js1/7.html). Create an input box and
...
- **[Part 2](https://songz.pathacks.com/js1/7b.html)**: Add the new text that was
...
8. [Stopwatch](https://songz.pathacks.com/js1/8.html) (every 10 milliseconds)
...
- **[Part 2](https://songz.pathacks.com/js1/8b.html)**: Add Pause and Stop buttons
...
9. [Blinker](https://songz.pathacks.com/js1/9.html): Flashing text website that
...
1. [Countdown from Input](https://songz.pathacks.com/js1/countdown.html)
...
2. [Chat Input](https://songz.pathacks.com/js1/chatInput.html)
...
3. [Letter Filter](https://songz.pathacks.com/js1/letterFilter.html)
...
4. [Increase 1](https://songz.pathacks.com/js1/increase1.html)
...
5. [Toggle](https://songz.pathacks.com/js1/toggle.html)
