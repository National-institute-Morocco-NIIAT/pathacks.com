    ...
    <SessionProvider session={session} refetchInterval={5 * 60}>
      <ApolloProvider client={apolloClient}>
        <ContextProvider>
          <Head>
            {/* <!-- Primary Meta Tags --> */}
            <meta name="title" content="Pathacks" />
            <meta
              name="description"
            ...
            <meta property="og:url" content="https://www.pathacks.com/" />
            <meta
              property="og:title"
              content="Pathakcs — Learn Javascript the old school way"
            />
            <meta
            ...
            <meta
              property="og:image"
              content="https://www.pathacks.com/assets/c0d3-meta.svg"
            />

            {/* <!-- Twitter --> */}
            <meta property="twitter:card" content="summary_large_image" />
            <meta property="twitter:url" content="https://www.pathacks.com/" />
            <meta
              property="twitter:title"
              content="Pathacks — Learn Javascript the old school way"
            />
            <meta
            ...
            {/* <!-- Safari Web Content --> */}
            <meta name="apple-mobile-web-app-title" content="Pathacks" />
          </Head>
