...
const useRouterObj = {
  asPath: 'pathacks.com/admin/lessons/js1/modules',
  query: {
    pageName: 'modules',
    lessonSlug: 'js1'
  },
...
describe('modules', () => {
  ...
  it('Should render default page', async () => {
    ...
    useRouter.mockImplementation(() => ({
      asPath: 'pathacks.com/admin/lessons/1/none',
      query: {
        pageName: 'none',
        lessonSlug: 'js1'
      }
  ...
  it('Should set default lesson if there is no lesson param', async () => {
    ...
    useRouter.mockImplementation(() => ({
      asPath: 'pathacks.com/admin/lessons/1/modules',
      query: {
        pageName: 'modules',
...
describe('challenges', () => {
  const useRouterChallenges = {
    ...useRouterObj,
    asPath: 'pathacks.com/admin/lessons/js1/challenges',
    query: {
      ...useRouterObj.query,
      pageName: 'challenges'
    }
...
describe('introduction', () => {
  const useRouterIntroduction = {
    ...useRouterObj,
    asPath: 'pathacks.com/admin/lessons/js1/introduction',
    query: {
      ...useRouterObj.query,
...
describe('exercises', () => {
  const useRouterExercises = {
    ...useRouterObj,
    asPath: 'pathacks.com/admin/lessons/js0/exercises',
    query: {
      ...useRouterObj.query,
      lessonSlug: 'js0',
      pageName: 'exercises'
