      ...
      createMany: {
        data: [
          ...
          },
          {
            ...
            description:
              'Send a request to https://pokeapi.co/api/v2/pokemon/ and create [a Pokemon Viewer](https://songz.pathacks.com/js3/pokeview.html) . Have the viewer include previous and next buttons at the top of the page, and display 20 images and names of pokemon per page. ',
            order: 10
          }
        ]
      }
        ...
        data: [
          {
            ...
            description:
              'Example:\n\n![tree](https://pathacks.com/apis/draw?tree={%22v%22:30,%22children%22:[{%22v%22:50},{%22v%22:40}]})\n \n```\nconst a = {val: 30, right: {val: 40}, left: {val: 50}};\nsolution(a); // should return 50\n```',
            order: 1
          },
          {
            title: 'Given a binary tree, find the maximum depth',
            description:
              'Examples: \n\n![tree1](https://pathacks.com/apis/draw?tree={%22v%22:30,%22children%22:[{%22v%22:50},{%22v%22:50,%22children%22:[{%22v%22:10},{%22v%22:10}]}]})\n\n```\nconst a = (above tree);\nsolution(a); // should return 2\n```\n\n\n![tree1](https://pathacks.com/apis/draw?tree={%22v%22:30})\n\n```\nconst a = (above tree);\nsolution(a); // should return 0\n```',
            order: 2
          },
          {
            title:
...
export const adminData = Prisma.validator<Prisma.UserCreateInput>()({
  name: 'Admin Administrator',
  username: 'admin',
  password: '$2b$10$OKsH6r5//AtYlIW/EzUWQeUYdwcKF8JUEeD8RXfLURj8BPw1ilir2', // === password
  email: 'admin@mail.com',
  isAdmin: true
})

export const leetData = Prisma.validator<Prisma.UserCreateInput>()({
  name: 'Leet Coder',
  username: 'leetcoder',
  password: '$2b$10$OKsH6r5//AtYlIW/EzUWQeUYdwcKF8JUEeD8RXfLURj8BPw1ilir2', // === password
  email: 'leetcoder@mail.com',
  isAdmin: false
})

export const noobData = Prisma.validator<Prisma.UserCreateInput>()({
  name: 'Noob Newbie',
  username: 'newbie',
  password: '$2b$10$1N3HMPuhWETfwWZWEJp85ONwWbUbBet7.aeZFvdCBjqx5muZ6Elyq', // === password
  email: 'newbie@mail.com',
  isAdmin: false
})

export const userLessonData = (lessonId: number, userId: number) =>
...
export const starData = (
  ...
  Prisma.validator<Prisma.StarCreateManyInput>()({
    lessonId,
    studentId,
    mentorId,
    comment: 'U da best bro =P'
  })
